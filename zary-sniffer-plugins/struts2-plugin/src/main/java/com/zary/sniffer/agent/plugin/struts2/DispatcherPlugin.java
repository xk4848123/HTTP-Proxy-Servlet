...
public class DispatcherPlugin extends AbstractPlugin {
    private static final String TYPE = "org.apache.struts2.dispatcher.Dispatcher";
    private static final String HANDLER = "com.zary.sniffer.agent.plugin.struts2.handler.DispatcherHandler";
    private static final String METHOD = "serviceAction";
    ...
    public IInstanceMethodPoint[] getInstanceMethodPoints() {
        IInstanceMethodPoint point = new IInstanceMethodPoint() {
            ...
            public ElementMatcher<MethodDescription> getMethodsMatcher() {
                return named(METHOD).and(not(ElementMatchers.<MethodDescription>isStatic()));
            }
